...
class Flagships
{
    ...
    private static function vault(array $h): array
    {
        return [
            ...
            'hero' => $h['a'],
            'schema' => 'Product',
            'rooms' => ['boutique_expert', 'videos', 'gallery', 'journal', 'forum', 'reliques', 'personnages'],
    ...
    private static function terrain(array $h): array
    {
        return [
            ...
            'hero' => $h['p'],
            'schema' => 'VideoGame',
            'rooms' => ['vivre', 'forum', 'personnages', 'videos', 'guides', 'reliques', 'guilde', 'journal', 'agenda'],
    ...
    private static function atelier(array $h): array
    {
        return [
            ...
            'hero' => $h['sea'],
            'schema' => 'TVSeries',
            'rooms' => ['vivre', 'forum', 'personnages', 'videos', 'journal', 'stories', 'boutique', 'guides'],
    ...
    private static function territoire(array $h): array
    {
        return [
            ...
            'hero' => $h['p'],
            'schema' => 'Country',
            'rooms' => ['vivre', 'journal', 'personnages', 'videos', 'carte', 'agenda', 'boutique', 'guides', 'forum'],
    ...
    private static function maison(array $h): array
    {
        return [
            ...
            'schema' => 'Organization',
            'rooms' => ['offres', 'epreuve', 'journal', 'videos', 'guides', 'forum', 'guilde'],
    ...
    private static function scene(array $h): array
    {
        return [
            ...
            'hero' => $h['s'],
            'schema' => 'MusicAlbum',
            'rooms' => ['vivre', 'audio', 'videos', 'agenda', 'boutique', 'journal', 'forum', 'gallery', 'personnages'],
    ...
    private static function arene(array $h): array
    {
        return [
            ...
            'hero' => $h['m'],
            'schema' => 'SportsTeam',
            'rooms' => ['vivre', 'agenda', 'personnages', 'videos', 'journal', 'forum', 'gallery', 'boutique', 'guilde'],
    ...
    private static function labo(array $h): array
    {
        return [
            ...
            'hero' => $h['s'],
            'schema' => 'Course',
            'rooms' => ['vivre', 'videos', 'guides', 'epreuve', 'journal', 'forum', 'personnages', 'offres', 'agenda'],
    ...
    private static function plateau(array $h): array
    {
        return [
            ...
            'hero' => $h['s'],
            'schema' => 'Movie',
            'rooms' => ['vivre', 'videos', 'personnages', 'journal', 'gallery', 'forum', 'guides', 'reliques', 'agenda'],
    ...
    private static function table(array $h): array
    {
        return [
            ...
            'hero' => $h['m'],
            'schema' => 'Recipe',
            'rooms' => ['guides', 'boutique_expert', 'journal', 'videos', 'carte', 'forum', 'gallery', 'agenda'],

...
class WorldTemplates
{
    ...
    public static function all(): array
    {
        ...
        $rows = [
            ...
            ['sim-tycoon', 'Jeux', 'Gestion / tycoon', 'Guides éco, mods', 'Tableurs + magazine', 'series', 'living', '#65a30d', $h['g'], 'VideoGame', array_merge($R, ['guides']), [['Version', 'text']], [], '{name} — guides gestion', 'HowTo économique.'],

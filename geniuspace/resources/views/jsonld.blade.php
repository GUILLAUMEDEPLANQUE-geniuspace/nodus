...
<main class="wrap" style="padding:2rem 1.25rem 6rem;max-width:52rem">
  ...
  <p class="muted">Chaque salle compile son graphe. Google et les LLM le lisent. Copie, ping, sitemap.</p>
  ...
  <p class="rel" style="margin-top:1rem">
    <a class="btn" href="/n/{{ $node->slug }}/schema.json">Graphe complet .json</a>
